...
{
    public class SapTipoCambioController : BaseController
    {
        /// <summary>
        /// Vista principal
        /// </summary>
        ...
        {
            var model = SapTipoCambioLogic.GetListViewModel(GetDataContext());
            return View(model);
        }
        ...
        /// <returns></returns>
        public ActionResult _PagedList(ListSapTipoCambioViewModel model, string filter, int? page)
        {
            ViewBag.filter = model.Filter;
            model.PagedList = SapTipoCambioLogic.GetPagedList(GetDataContext(), filter, page);
        ...
        public ActionResult _FilterList(string filter)
        {
            ...
            var list = SapTipoCambioLogic.GetPagedList(GetDataContext(), filter, null);
